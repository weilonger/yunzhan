		...
		<nav class="navbar navbar-default navbar-fixed-top navbar-blue" role="navigation">
			...
			<!-- 导航logo -->
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="/admin"><img style="display:inline" width="30px" src="/style/admin/img/1.png" alt="">   后台管理系统</a>
				</div>
		...
		<div class="row body">
			...
			<div class="col-md-2">
				...
				<div class="panel panel-primary">
					...
					<ul class="list-group">
					    <li class="list-group-item"><a href="/admin/user/0">教师列表</a></li>
						<li class="list-group-item"><a href="/admin/user/1">学生列表</a></li>
					</ul>
				</div>
