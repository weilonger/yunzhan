            ...
            @if(count($question))
                <table class="table-bordered table table-hover">
                    ...
                    <td>
                        ...
                        <a href="/download/{{$type = 'Question'}}/{{$value->extras}}" class="glyphicon glyphicon-download"></a>&nbsp
                        <a href="javascript:;" onclick="add({{$value->id}})" data-toggle="modal" data-target="#add" class="glyphicon glyphicon-upload"></a>
                    </td>
                    </tr>
                    @endforeach
                </table>
...
//            dropZoneClickTitle: "或者点击此区域添加图片",
                ...
                uploadExtraData: { '_token':'{{csrf_token()}}','type':'work'},
        ...
        function addwork(){
            ...
            // 提交到下一个页面
            $.post('/student/addwork',{str:str,'_token':'{{csrf_token()}}'},function(data){
                if (data==1) {
                    // 关闭弹框
                    $(".close").click();
