    ...
    <script type="text/javascript">
        ...
        function checkSubmitEmail() {
            if ($("#mail").val() == "") {
                ...
                $("#MailCheck").css("color", "color:#FF0000;");
                alert("邮箱不能为空!");
                return false;
            }
            if (!$("#mail").val().match(/^\w+((-\w+)|(\.\w+))*\@[A-Za-z0-9]+((\.|-)[A-Za-z0-9]+)*\.[A-Za-z0-9]+$/)) {
                $("#MailCheck").text("邮箱格式不正确");
                $("#MailCheck").css("color", "color:#FF0000;");
                alert("邮箱格式不正确！");
                return false;
            }
            $("#MailCheck").text("邮箱符合");
            $("#MailCheck").css("color", "color:#28FF28;");
            return true;
        }
            ...
            <div class="col-md-12 column">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" style="width:300px;" id="mail" />
                        </div>
                        <div class="col-sm-10">
                            <p style="padding-left: 180px"> &nbsp&nbsp<span id="MailCheck"></span></p>
                        </div>
                    </div>
                    <div class="form-group">
