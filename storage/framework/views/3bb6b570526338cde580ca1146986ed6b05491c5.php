...
<div class="col-md-10">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<a href="/teacher/course" class="btn btn-info"><span class="	glyphicon glyphicon-home"></span> 课程页面</a>
		...
		<div class="panel-body">
			<form action="" onsubmit="return false;" id="formAdd">
				...
				<div class="form-group">
					...
					<br>
					<input type="radio" name="isable" value="1">是
					<input type="radio" name="isable" value="0" checked>否
				</div>
				<div class="form-group">
...
<script>
    function add(){
        ...
        // 提交到下一个页面
        $.post('/teacher/course/charu',{str:str,'_token':'<?php echo e(csrf_token()); ?>'},function(data){
            if (data == 1) {
                console.log('成功');
